...
{
    public partial class SQLImportJob_M : Form
    {
        private const int CpNocloseButton = 0x200;

        public SQLImportJob_M()
        {
            InitializeComponent();
        }
        ...
        private IJobDetail GetImportJobDetail()
        {
            var detail = JobBuilder
                .Create()
                .OfType(Type.GetType("RecurringIntegrationsScheduler.Job.SQLImport_M,RecurringIntegrationsScheduler.Job.SQLImport_M", true))
